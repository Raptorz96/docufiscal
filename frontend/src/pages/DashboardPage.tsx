...
const DashboardPage: React.FC = () => {
  ...
  const critici = stats?.contratti_critici ?? [];
      ...
      <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
        <div className="p-6 border-b border-gray-50 flex items-center justify-between">
          <div className="flex items-center space-x-3">
            ...
            <h2 className="text-xl font-bold text-gray-900">Contratti Critici</h2>
          </div>
          <span className="px-3 py-1 bg-indigo-50 text-indigo-700 rounded-full text-xs font-semibold">
            {critici.length} contratti
          </span>
        </div>
        ...
        {critici.length > 0 ? (
          ...
          <div className="p-12 text-center">
            ...
            <p className="text-gray-500 font-medium">Nessun contratto scaduto o in scadenza nei prossimi 30 giorni.</p>
          </div>
        )}
      </div>
