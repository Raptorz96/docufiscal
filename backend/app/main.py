...
from app.api import auth_router, clienti_router, tipi_contratto_router, contratti_router, documenti_router
...
app.include_router(documenti_router, prefix="/api/v1", tags=["documenti"])
